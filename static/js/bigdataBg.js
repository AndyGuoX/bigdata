export function operateBdBg(element, eleWrap) {
    var num = 200;
    ...
    (function () {
        ...
        Build.prototype.go = function () {
            ...
            this.canvas.width = eleWrap.offsetWidth;
            this.canvas.height = eleWrap.offsetHeight * 0.9;
        ...
        Build.prototype.add = function () {
            ...
            this.calc.push({x: 360 * Math.random(), y: 360 * Math.random(), z: 360 * Math.random()});
        };
